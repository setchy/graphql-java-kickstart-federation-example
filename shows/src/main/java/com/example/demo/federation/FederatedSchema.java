...
public class FederatedSchema {
    ...
    /**
     * This transformation is not necessary when using Apollo Gateway with Managed Federation.
     * When using Apollo Gateway with an explicit `serviceList` (see apollo-gateway/index.js)
     * it was complaining with the following"
     *
     *      Error checking for changes to service definitions: Couldn't load service definitions for
     *      "shows" at http://localhost:8080/graphql:
